...
class TrainPipeline:
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            logging.info(f'Gathering data from MongoDB')
    ...
    def start_data_validation(self, data_ingestion_artifact: DataIngestionArtifact) -> DataValidationArtifact:
        """
            This method of TrainPipeline class is responsible for initiating data validation component
        """
        ...
        try:
            ...
            logging.info(f'Data validation operation completed. Exiting...')
