...
class MongoDBClient:
    """
        MongoDBClient is responsible for establishing connection to MongoDB database.
        Attributes:
        -----------
        client: MongoClient
    ...
    def __init__(self, database_name: str = DATABASE_NAME) -> None:
        ...
        """
        try:
            # check if a mongoDB client connection has already been established. If not, create a new connection
