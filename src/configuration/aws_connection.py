...
class S3Client:
    ...
    def __init__(self, region_name = REGION_NAME):
        """
            This class gets the aws credentials from env variables and creates a connection with s3 
            bucket and raises an exception when environment variables are not set
        """
