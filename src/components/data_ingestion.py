...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        Output:     : Data is returned as an artifcat of data ingestion component
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        """
            ...
            Description :   This methid initiates the data ingestion components of training pipeline
        ...
        try:
            ...
            logging.info(f'Data recieved from MongoDB')
